...
class AbstractDQNAgent(Agent):
    """Write me
    """
    def __init__(self, nb_actions, memory, gamma=.9, batch_size=32, nb_steps_warmup=1000,
                 train_interval=1, memory_interval=1, target_model_update=10000, vary_eps=True, anneal_steps=None,
...
class KODQNAgent(AbstractDQNAgent):
    """
    # Arguments
    ...
    def __init__(self, model, policy=None, test_policy=None, enable_double_dqn=False, enable_dueling_network=False,
                 dueling_type='avg', vary_eps=False, anneal_steps=None, *args, **kwargs):
        super(KODQNAgent, self).__init__(*args, **kwargs)
        ...
        # eGreedy parameters - Additional by KO
        self.init_exp = 0.9 
        self.final_exp = 0.0
        self.exploration = self.init_exp
        self.anneal_steps = anneal_steps
    ...
    def get_config(self):
        config = super(KOBasicDQNAgent, self).get_config()
